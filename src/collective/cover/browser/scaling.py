...
class ImageScaling(BaseImageScaling):
    ...
    def create(
        ...
        if not IPersistentCoverTile.providedBy(self.context):
            base_scales = queryMultiAdapter(
                (self.context, self.request), name="images", default=None
            )
        ...
        try:
            ...
            raise
        except Exception:  # noqa: B901 FIXME: blind except: statement
            logging.exception(
