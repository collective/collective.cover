    ...
    def test_controlpanel_permissions(self):
        ...
        for r in roles:
            with api.env.adopt_roles([r]):
                ...
                self.assertIn("cover", configlets, "configlet not listed for " + r)
...
class RegistryTestCase(unittest.TestCase):
    ...
    def test_available_tiles_record_in_registry(self):
        ...
        self.assertListEqual(self.settings.available_tiles, DEFAULT_AVAILABLE_TILES)
    ...
    def test_searchable_content_types_record_in_registry(self):
        ...
        self.assertListEqual(
            self.settings.searchable_content_types, DEFAULT_SEARCHABLE_CONTENT_TYPES
        )
    ...
    def test_grid_system_record_in_registry(self):
        ...
        self.assertEqual(self.settings.grid_system, DEFAULT_GRID_SYSTEM)
