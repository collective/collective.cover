...
class TestTextLinesSortableWidget(unittest.TestCase):
    ...
    def test_get_custom_url(self):
        ...
        self.assertEqual(
            widget.get_custom_url(obj2.UID()), u"http://nohost/plone/my-image1/view"
        )
        self.assertEqual(
            widget.get_custom_url(obj3.UID()), u"http://nohost/plone/my-image2/view"
        )
    ...
    def test_utf8_custom_data(self):
        ...
        self.assertIsInstance(widget.get_custom_title(obj1.UID()), six.text_type)
        self.assertIsInstance(widget.get_custom_description(obj1.UID()), six.text_type)
        self.assertEqual(widget.get_custom_title(obj2.UID()), u"áéíóú")
        self.assertEqual(widget.get_custom_description(obj2.UID()), u"áéíóú")
        self.assertIsInstance(widget.get_custom_title(obj2.UID()), six.text_type)
        self.assertIsInstance(widget.get_custom_description(obj2.UID()), six.text_type)
